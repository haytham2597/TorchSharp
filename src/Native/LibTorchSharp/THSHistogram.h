...
EXPORT_API(void) THSHistogram_histogram(const Tensor input, const int64_t bins, double* ranges, int64_t length, Tensor weight, bool density = false, Tensor hist, Tensor hist_bins);
EXPORT_API(void) THSHistogram_histogram_tensor(const Tensor input, const Tensor bins, const double* ranges, int64_t length, Tensor weight, bool density = false, Tensor hist, Tensor hist_bins);
